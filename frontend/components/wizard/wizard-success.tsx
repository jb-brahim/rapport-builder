  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        <h2 className="text-4xl font-black text-[#250136] tracking-tight leading-tight">
          {t('wizard.success.title', { defaultValue: 'Mission Accomplished!' })}
        </h2>
        <p className="text-[#250136]/60 font-bold text-lg max-w-md mx-auto leading-relaxed">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="p-4 rounded-2xl bg-red-50 text-red-500 group-hover:scale-110 transition-transform">
      ...
      <div className="pt-8 w-full space-y-4">
        ...
        <button
          ...
          className="flex items-center gap-2 text-[#250136]/40 font-black text-xs uppercase tracking-widest hover:text-primary transition-colors py-2"
        >
